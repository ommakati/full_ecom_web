...
import { dbAuth } from './database-auth.js'
...
router.post('/items', dbAuth, async (req, res) => {
  try {
    const userId = req.user.id
...
router.put('/items/:id', dbAuth, async (req, res) => {
  try {
    const userId = req.user.id
    const { id } = req.params
...
router.delete('/items/:id', dbAuth, async (req, res) => {
  try {
    const userId = req.user.id
    const { id } = req.params
...
router.delete('/', dbAuth, async (req, res) => {
  try {
    const userId = req.user.id
